		...
		div1.onmouseover=function(){
			...
			smallImg.src="./images/mao1.jpg";
        	bigImg.src="./images/mao1.jpg";
		}
		div2.onmouseover=function(){
			...
			div4.style.border="1px solid #fff";
			div5.style.border="1px solid #fff";
			smallImg.src="./images/mao2.jpg";
        	bigImg.src="./images/mao2.jpg";
		}
		div3.onmouseover=function(){
			...
			div4.style.border="1px solid #fff";
			div5.style.border="1px solid #fff";
			smallImg.src="./images/mao3.jpg";
        	bigImg.src="./images/mao3.jpg";
		}
		div4.onmouseover=function(){
			...
			div3.style.border="1px solid #fff";
			div5.style.border="1px solid #fff";
			smallImg.src="./images/mao4.jpg";
        	bigImg.src="./images/mao4.jpg";
		}
		div5.onmouseover=function(){
			...
			div3.style.border="1px solid #fff";
			div4.style.border="1px solid #fff";
			smallImg.src="./images/mao5.jpg";
        	bigImg.src="./images/mao5.jpg";
		}